...
$.ajax({
    ...
    data: {
        key: 'Z4KBZ-ZXDYZ-2KXX4-7VT4L-PFIPS-Z6FZL',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(116.397128, 39.916527, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
